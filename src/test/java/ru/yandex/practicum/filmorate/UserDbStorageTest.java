...
class UserDbStorageTest {
    ...
    public void testAddUser() {
        ...
        Optional<User> userOptional = userStorage.createUser(newUser);
    ...
    public void testAddFriend() {
        ...
        Optional<User> optionalUser1 = userStorage.createUser(user1);
        ...
        Optional<User> optionalUser2 = userStorage.createUser(user2);
    ...
    public void testGetCommonsFriends() {
        ...
        Optional<User> optionalUser3 = userStorage.createUser(user3);
