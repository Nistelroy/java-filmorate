...
public class FilmDbStorageTest {
    ...
    public void testGetFilmWithWrongId() {
        Optional<Film> optionalFilm = filmStorage.getFilm(555);
    ...
    public void testAddLike() {
        ...
        Optional<User> optionalUser = userStorage.createUser(newUser);
    ...
    public void testGetPopularFilms() {
        ...
        Optional<User> userOptional1 = userStorage.createUser(newUser1);
        ...
        Optional<User> userOptional2 = userStorage.createUser(newUser2);
